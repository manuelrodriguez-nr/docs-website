...
<Callout variant="tip">
New Relic needs access to AWS Config Service to detect, identify and monitor your AWS services. Disabling the access will lead to an incomplete monitoring and poor New Relic experience.
</Callout>
